...
CREATE TABLE IF NOT EXISTS `yii_visitas` (
  ...
  `vis_tipo_publico` varchar(255) NOT NULL,
  `vis_cant_publico` int(11) NOT NULL,
...
INSERT INTO `yii_visitas` (`id_vis`, `vis_tipo_publico`, `vis_cant_publico`, `vis_fecha`, `no_fun`) VALUES
(5, 'Adulto', 5, '2012-07-12', 1);
