...
--
-- Servidor: localhost
-- Tiempo de generación: 21-12-2012 a las 00:17:34
...
--
-- Volcado de datos para la tabla `privacysetting`
--
...
--
-- Volcado de datos para la tabla `profile_visit`
--
...
(1, 'admin', 'd1557061693ff641cde7b8d2edf377c5', '', 1343830560, 1356048539, 1355686540, 1344295071, 1, 1, NULL, 'Instant'),
...
--
-- Estructura de tabla para la tabla `yii_configuracion`
--
...
--
-- Volcado de datos para la tabla `yii_configuracion`
--
...
--
-- Estructura de tabla para la tabla `yii_fallos`
--
...
--
-- Volcado de datos para la tabla `yii_fallos`
--
...
--
-- Estructura de tabla para la tabla `yii_funcion`
--
...
--
-- Volcado de datos para la tabla `yii_funcion`
--
...
--
-- Estructura de tabla para la tabla `yii_reservacion_especial`
--
...
--
-- Volcado de datos para la tabla `yii_reservacion_especial`
--
...
--
-- Estructura de tabla para la tabla `yii_reservacion_publica`
--
...
--
-- Volcado de datos para la tabla `yii_reservacion_publica`
--
...
--
-- Estructura de tabla para la tabla `yii_visitas`
--
...
--
-- Volcado de datos para la tabla `yii_visitas`
--
