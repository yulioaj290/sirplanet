-- NOTAS DE VERSION
-- Salva realizada al finalizar los CRUD Configuracion, Funcion, Visitas, R. Publica y R. Especial
-- ---------------------------------------------------------------
...
--
-- Servidor: localhost
-- Tiempo de generación: 17-08-2012 a las 21:44:06
...
(1, 'admin', 'd1557061693ff641cde7b8d2edf377c5', '', 1343830560, 1345237116, 1345237120, 1344295071, 1, 1, NULL, 'Instant'),
...
CREATE TABLE IF NOT EXISTS `yii_reservacion_especial` (
  ...
  `re_direccion` varchar(1000) NOT NULL,
  `re_telefono` int(10) DEFAULT NULL,
...
INSERT INTO `yii_reservacion_especial` (`id_re`, `re_ci`, `re_nombre`, `re_apellidos`, `re_cant_personas`, `re_fecha`, `no_fun`, `re_nombre_entidad`, `re_direccion`, `re_telefono`, `re_email`) VALUES
(1, '50012859785', 'Pedro', 'Aleman Vega', 50, '2012-08-16', 1, 'EPICOL', 'Ave del Puerto No.21, La Coloma P. Del Río', 794100, 'yajimenez@estudiantes.uci.cu');
