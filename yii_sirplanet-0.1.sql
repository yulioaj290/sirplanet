...
--
-- Servidor: localhost
-- Tiempo de generación: 05-08-2012 a las 22:55:00
...
(1, 'admin', 'd1557061693ff641cde7b8d2edf377c5', '', 1343830560, 1344205608, 1344205819, 1344202841, 1, 1, NULL, 'Instant'),
(2, 'demo', 'fe01ce2a7fbac8fafaed7c982a04e229', '', 1343830560, 1343846375, 0, 0, 0, 1, NULL, 'Instant');
...
DROP TABLE IF EXISTS `yii_configuracion`;
...
DROP TABLE IF EXISTS `yii_funcion`;
...
DROP TABLE IF EXISTS `yii_reservacion_especial`;
...
DROP TABLE IF EXISTS `yii_reservacion_publica`;
...
DROP TABLE IF EXISTS `yii_visitas`;
