...
(7, 'vis_admin', 'Administracion de visitas', NULL),
(8, 'vis_create', 'Crear nueva visita', NULL),
(9, 'vis_registrar', 'Registrar nueva visita libre', NULL),
(10, 'vis_update', 'Modificar visita', NULL),
(11, 'vis_verificar', 'Verificar visita de la funcion X', NULL),
(12, 'vis_view', 'Ver detalles de visita', NULL),
(13, 'rpub_admin', 'Administrar reservaciones publicas', NULL),
(14, 'rpub_create', 'Crear reservaciones publicas', NULL),
(15, 'rpub_update', 'Modificar reservaciones publicas', NULL),
(16, 'rpub_updateres', 'Modificar reservaciones publicas por usuario publico', NULL),
(17, 'rpub_actualizar', 'Buscar reservacion para modificar reservaciones publicas por el usuario publico.', NULL),
(18, 'rpub_cancelar', 'Buscar reservacion para cancelar reservaciones publicas por el usuario publico', NULL),
(19, 'rpub_capacidades', 'Consultar capacidades de reservaciones publicas para reservar por el usuario publico', NULL),
(20, 'rpub_info', 'Muestra datos de reservaciones publicas creadas por el usuario publico', NULL),
(21, 'rpub_reservar', 'Reservar reservaciones publicas por el usuario publico', NULL),
(22, 'rpub_view', 'Ver detalles de reservaciones publicas', NULL),
(23, 'resp_admin', 'Administrar reservaciones especiales', NULL),
(24, 'resp_create', 'Crear nuevas reservaciones especiales', NULL),
(25, 'resp_update', 'Modificar reservaciones especiales', NULL),
(26, 'resp_view', 'Ver detalles de reservaciones especiales', NULL),
(27, 'site_calendario', 'Ver capacidades en calendario mensual', NULL),
(28, 'site_capacidades', 'Ver capacidades de reservaciones de una fecha dada, escogida desde el calendario mensual', NULL),
(29, 'site_contact', 'Contactar a los administradores del sistema', NULL),
(30, 'site_index', 'Pagina de inicio del sistema', NULL),
(31, 'site_login', 'Pagina de logueo del sistema', NULL),
(32, 'site_about', 'Pagina de acerca de del sistema', NULL),
(33, 'rep_index', 'Resumen de visitas', NULL),
(34, 'rep_estadisticas_guiadas', 'Estadisticas de visitas guiadas', NULL),
(35, 'rep_estadisticas_libres', 'Estadisticas de visitas libres', NULL),
(36, 'rep_estadisticas_totales', 'Estadisticas de todas las visitas', NULL),
(37, 'fun_admin', 'Administrar funciones', NULL),
(38, 'fun_create', 'Crear nuevas funciones', NULL),
(39, 'fun_update', 'Modificar funciones', NULL),
(40, 'fun_view', 'Ver detalles de funciones', NULL),
(41, 'config_index', 'Mostrar la configuracion actual', NULL),
(42, 'config_update', 'Modificar la configuracion actual', NULL);
...
(1, 1, '2012-08-01 14:16:01', 'protected', 'admin', 'admin', 1, 1, 'webmaster@example.com', '', '', ''),
(2, 2, '2012-08-01 14:16:01', 'protected', 'demo', 'demo', 1, 1, 'demo@example.com', NULL, NULL, NULL),
(3, 3, '0000-00-00 00:00:00', 'protected', 'Aleman Jimenez', 'Yulio', 1, 1, 'yajimenez@estudiantes.uci.cu', '', '', '');
...
(1, 2, 1344293777, 1344293777, 1),
(2, 1, 1345000844, 1345000844, 1);
...
(5, 'Secretaria', 'Persona encargada de realizar reservaciones al pubico y registrar las visitad diarias', 0, NULL, NULL),
(6, 'Supervisor', 'Persona encargada de realizar reservaciones especiales a entidades del pais, ver estad''isticas y resumen de visitas, administrar calendario y funciones.', 0, NULL, NULL);
...
(1, 'admin', 'd1557061693ff641cde7b8d2edf377c5', '', 1343830560, 1362324412, 1362331730, 1344295071, 1, 1, NULL, 'Instant'),
(2, 'demo', 'fe01ce2a7fbac8fafaed7c982a04e229', '', 1343830560, 1345000834, 0, 0, 0, 1, NULL, 'Instant');
...
--
-- Table structure for table `yii_configuracion`
--

CREATE TABLE IF NOT EXISTS `yii_configuracion` (
  `id_config` int(11) NOT NULL AUTO_INCREMENT,
  `cant_total_res` int(11) NOT NULL,
  `cant_res_reserva` int(11) NOT NULL,
  `cant_res_online` int(11) NOT NULL,
  `cant_personas_rp` int(11) NOT NULL,
  `cant_personas_re` int(11) NOT NULL,
  PRIMARY KEY (`id_config`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `yii_configuracion`
--

INSERT INTO `yii_configuracion` (`id_config`, `cant_total_res`, `cant_res_reserva`, `cant_res_online`, `cant_personas_rp`, `cant_personas_re`) VALUES
(1, 60, 5, 30, 5, 60);

-- --------------------------------------------------------

--
-- Table structure for table `yii_fallos`
--

CREATE TABLE IF NOT EXISTS `yii_fallos` (
  `id_fs` int(11) NOT NULL AUTO_INCREMENT,
  `fs_fecha` date NOT NULL,
  `no_fun` int(11) NOT NULL,
  `fs_fallos` int(3) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_fs`),
  KEY `no_fun` (`no_fun`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=16 ;

--
-- Dumping data for table `yii_fallos`
--

INSERT INTO `yii_fallos` (`id_fs`, `fs_fecha`, `no_fun`, `fs_fallos`) VALUES
(11, '2012-12-21', 2, 60),
(13, '2012-12-19', 4, 60),
(14, '2012-12-19', 1, 55),
(15, '2012-12-21', 3, 56);
...
--
-- Table structure for table `yii_funcion`
--

CREATE TABLE IF NOT EXISTS `yii_funcion` (
  `no_fun` int(11) NOT NULL,
...
--
-- Dumping data for table `yii_funcion`
--

INSERT INTO `yii_funcion` (`no_fun`, `hora_fun`) VALUES
(1, '10:00:00'),
(2, '11:00:00'),
(3, '14:30:00'),
(4, '15:30:00');
...
--
-- Table structure for table `yii_reservacion_especial`
--

CREATE TABLE IF NOT EXISTS `yii_reservacion_especial` (
  `id_re` int(11) NOT NULL AUTO_INCREMENT,
  `re_ci` varchar(11) NOT NULL,
  `re_nombre` varchar(255) NOT NULL,
  `re_apellidos` varchar(500) NOT NULL,
  `re_cant_personas` int(3) NOT NULL,
  `re_fecha` date NOT NULL,
  `no_fun` int(11) NOT NULL,
  `re_tipo_entidad` varchar(500) NOT NULL,
  `re_nombre_entidad` varchar(500) NOT NULL,
  `re_direccion` varchar(1000) DEFAULT NULL,
  `re_telefono` int(10) NOT NULL,
  `re_email` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`id_re`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=11 ;

--
-- Dumping data for table `yii_reservacion_especial`
--

INSERT INTO `yii_reservacion_especial` (`id_re`, `re_ci`, `re_nombre`, `re_apellidos`, `re_cant_personas`, `re_fecha`, `no_fun`, `re_tipo_entidad`, `re_nombre_entidad`, `re_direccion`, `re_telefono`, `re_email`) VALUES
(1, '50012859785', 'Pedro', 'Aleman Vega', 50, '2012-08-16', 1, 'Otra Entidad', 'EPICOL', 'Ave del Puerto No.21, La Coloma P. Del Río', 794100, 'yajimenez@estudiantes.uci.cu'),
(2, '90112921087', 'Yulio', 'Aleman Jimenez', 20, '2012-09-26', 2, 'Centro de Estudios', 'UCI', '', 8358299, ''),
(3, '54651365168', 'Eduardo', 'Gonzalez Fernandez', 54, '2012-09-29', 1, 'Circulo de Abuelos', 'Seguimos en combate', '', 5864785, ''),
(7, '54651365168', 'Carlos', 'Garcia Esteves', 30, '2012-09-26', 2, 'Centro de Estudios', 'CUJAE', '', 2165131, ''),
(9, '54651365168', 'Eduardo', 'Carmona Torres', 30, '2012-09-28', 2, 'Centro de Estudios', 'CUJAE', '', 5864785, ''),
(10, '90112921087', 'Yulio', 'Aleman Jimenez', 42, '2012-12-19', 2, 'Centro de Estudios', 'UCI', '', 79424856, '');

-- --------------------------------------------------------

--
-- Table structure for table `yii_reservacion_publica`
--

CREATE TABLE IF NOT EXISTS `yii_reservacion_publica` (
  `id_rp` int(11) NOT NULL AUTO_INCREMENT,
  `rp_ci` varchar(11) NOT NULL,
  `rp_nombre` varchar(255) NOT NULL,
  `rp_apellidos` varchar(500) NOT NULL,
  `rp_cant_personas` int(2) NOT NULL,
...
--
-- Dumping data for table `yii_reservacion_publica`
--

INSERT INTO `yii_reservacion_publica` (`id_rp`, `rp_ci`, `rp_nombre`, `rp_apellidos`, `rp_cant_personas`, `rp_fecha`, `no_fun`) VALUES
(1, '90112921087', 'Yulio', 'Aleman Jimenez', 4, '2012-08-22', 4),
(4, '57081759854', 'Fidela', 'Jimenez Martinez', 4, '2012-09-26', 2),
(5, '59041254863', 'Jesus', 'Hernandez Graveran', 2, '2012-09-27', 3),
(6, '67022557832', 'Elena', 'Rodriguez Carmenate', 5, '2012-09-28', 2),
(7, '92021257852', 'Caridad', 'Bello Aleman', 5, '2012-09-28', 2),
(8, '90112921087', 'Yulio', 'Aleman Jimenez', 5, '2012-12-19', 1),
(9, '50012812345', 'Pedro', 'Aleman Vega', 4, '2012-12-19', 2),
(10, '90112921087', 'Yulio', 'Aleman Jimenez', 3, '2012-12-19', 2),
(11, '50012812345', 'Pedro', 'Aleman Vega', 4, '2012-12-20', 4),
(14, '57081712345', 'Fidela', 'Jimenez Martinez', 4, '2012-12-21', 3);

-- --------------------------------------------------------

--
-- Table structure for table `yii_visitas`
--

CREATE TABLE IF NOT EXISTS `yii_visitas` (
  `id_vis` int(11) NOT NULL AUTO_INCREMENT,
  `vis_fecha` date NOT NULL,
  `no_fun` int(11) NOT NULL DEFAULT '0',
  `vis_ninnos_nacionales` int(20) DEFAULT NULL,
  `vis_adultos_nacionales` int(20) DEFAULT NULL,
  `vis_ninnos_extranj` int(20) DEFAULT NULL,
  `vis_adultos_extranj` int(20) DEFAULT NULL,
  PRIMARY KEY (`id_vis`),
  KEY `no_fun` (`no_fun`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=23 ;

--
-- Dumping data for table `yii_visitas`
--

INSERT INTO `yii_visitas` (`id_vis`, `vis_fecha`, `no_fun`, `vis_ninnos_nacionales`, `vis_adultos_nacionales`, `vis_ninnos_extranj`, `vis_adultos_extranj`) VALUES
(14, '2012-11-29', 3, 4, 3, NULL, 6),
(17, '2012-12-19', 2, NULL, 2, NULL, NULL),
(18, '2013-02-27', 0, 8, 12, 20, 6),
(19, '2013-02-28', 1, 10, 2, NULL, 4),
(20, '2013-03-01', 2, 30, NULL, 5, 10),
(21, '2013-03-02', 3, 4, 13, 21, NULL),
(22, '2013-03-03', 4, NULL, 24, 15, 7);
