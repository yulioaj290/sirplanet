...
class CNumberValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		if($this->integerOnly)
		{
			...
			{
				$message=$this->message!==null?$this->message:Yii::t('yii','{attribute} debe ser un entero.');
		...
		else
		{
			...
			{
				$message=$this->message!==null?$this->message:Yii::t('yii','{attribute} debe ser un n&uacute;mero.');
				$this->addError($object,$attribute,$message);
			}
		}
		if($this->min!==null && $value<$this->min)
		{
			$message=$this->tooSmall!==null?$this->tooSmall:Yii::t('yii','{attribute} es muy peque&ntilde;o (m&iacute;nimo {min}).');
			$this->addError($object,$attribute,$message,array('{min}'=>$this->min));
		}
		if($this->max!==null && $value>$this->max)
		{
			$message=$this->tooBig!==null?$this->tooBig:Yii::t('yii','{attribute} es muy grande (m&aacute;ximo {max}).');
	...
	public function clientValidateAttribute($object,$attribute)
	{
		...
		if(($message=$this->message)===null)
			$message=$this->integerOnly ? Yii::t('yii','{attribute} debe ser un entero.') : Yii::t('yii','{attribute} debe ser un n&uacute;mero.');
		$message=strtr($message, array(
			'{attribute}'=>$label,
		));

		if(($tooBig=$this->tooBig)===null)
			$tooBig=Yii::t('yii','{attribute} es muy grande (m&aacute;ximo {max}).');
		...
		if(($tooSmall=$this->tooSmall)===null)
			$tooSmall=Yii::t('yii','{attribute} es muy peque&ntilde;o (m&iacute;nimo {min}).');
