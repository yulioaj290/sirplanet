...
class CStringValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		{
			$message=$this->tooShort!==null?$this->tooShort:Yii::t('yii','{attribute} es muy corto (m&iacute;nimo {min} caracteres).');
			$this->addError($object,$attribute,$message,array('{min}'=>$this->min));
		}
		if($this->max!==null && $length>$this->max)
		{
			$message=$this->tooLong!==null?$this->tooLong:Yii::t('yii','{attribute} es muuy largo (m&aacute;ximo {max} caracteres).');
			$this->addError($object,$attribute,$message,array('{max}'=>$this->max));
		}
		if($this->is!==null && $length!==$this->is)
		{
			$message=$this->message!==null?$this->message:Yii::t('yii','{attribute} es de longitud incorrecta (deben ser {length} caracteres).');
	...
	public function clientValidateAttribute($object,$attribute)
	{
		...
		if(($message=$this->message)===null)
			$message=Yii::t('yii','{attribute} no tiene la longitud adecuada (deben ser {length} caracteres).');
		...
		if(($tooShort=$this->tooShort)===null)
			$tooShort=Yii::t('yii','{attribute} es muy corto (m&iacute;nimo {min} caracteres).');
		...
		if(($tooLong=$this->tooLong)===null)
			$tooLong=Yii::t('yii','{attribute} es muy grande (m&aacute;ximo {max} caracteres).');
