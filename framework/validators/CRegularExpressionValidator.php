...
class CRegularExpressionValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		if($this->pattern===null)
			throw new CException(Yii::t('yii','La propiedad del "campo" debe ser especificada con una expresi&oacute;n regular v&aacute;lida.'));
		if((!$this->not && !preg_match($this->pattern,$value)) || ($this->not && preg_match($this->pattern,$value)))
		{
			$message=$this->message!==null?$this->message:Yii::t('yii','{attribute} no es v&aacute;lido.');
