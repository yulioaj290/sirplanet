...
class CCaptchaValidator extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		{
			$message=$this->message!==null?$this->message:Yii::t('yii','El c&oacute;digo de verificaci&oacute;n no es v&aacute;lido.');
	...
	protected function getCaptchaAction()
	{
		if(($captcha=Yii::app()->getController()->createAction($this->captchaAction))===null)
		{
			...
			if($captcha===null)
				throw new CException(Yii::t('yii','CCaptchaValidator.action "{id}" no es v&aacute;lido. Inhabilitado para encontrar una acci&oacute;n en el controlador actual',
